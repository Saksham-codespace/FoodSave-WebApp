...
const prompts = [
    ...
    ["trust in north delhi","ngos in north delhi"],
    ["tell joke"],
  ...
  const replies = [
    ...
    ["Saksham and mithas created me"],
    ["I am FoodSave Chatbot"],
    ...
    ["Haha!","Good one!"],
    ["  The basic concept of this project  Foodsave Management is to collect theexcess/leftover food from donors such as hotels, restaurants, marriage halls, etc and distribute to  the  needy people"],
    [currentdate],
    [time],
    ["you can donate raw ,cooked and packed foods"],
    ["Delhi old age Charitable Trust,208, East Street, Near Keshavram Hospital, "],
    ["joke ha ha .."],
  ...
  const alternative = [
    ...
    // // "I'm listening...:/",
    // "I don't understand ",
    " I am developed by Saksham Bhardwaj & Mithas Kaushik"
  ]
